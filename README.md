...
* [Bulk Create Top Containers](https://github.com/bentley-historical-library/bulk_create_containers) (Bentley Historical Library) Adds an "Add Containers" button to the Accessions toolbar, allowing users to create container instances in bulk.
