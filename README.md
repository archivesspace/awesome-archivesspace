...
* Search Identifier plugin: [ArchivesSpace Advanced Search Extension](https://github.com/hudmol/extended_advanced_search) (Hudson Molonglo): This is an ArchivesSpace plugin to extend the advanced search to index and allow searching on a series of record fields as specified by Yale University.
...
* [Oauth plug-in](https://github.com/lyrasis/aspace-oauth) (Mark Cooper/LYRASIS): Configure ArchivesSpace as a service provider for oauth user authentication.
